...
"""
        data = {
            "Иванов Константин Дмитриевич": [
                ("математика", 91), ("химия", 100), ("физика", 85),
                ("литература", 90)
            ],
            "Петров Петр Семенович": [
                ("математика", 76), ("химия", 78), ("литература", 80),
                ("физика", 90)
            ],
            "Сидоров Сидр Сидорович": [
                ("математика", 82), ("химия", 79), ("литература", 88),
                ("программирование", 91)
            ],
            "Кузнецова Анна Викторовна": [
                ("математика", 92), ("литература", 84), ("физика", 78),
                ("химия", 93)
            ],
            "Михайлов Сергей Олегович": [
                ("математика", 75), ("химия", 82), ("физика", 70),
                ("математика", 88)
            ]
        }
